...
import com.no_country.salud_vital.domain.consulta.desafio.ValidadorCancelamientoDeConsulta;
import com.no_country.salud_vital.domain.consulta.validaciones.ValidadorDeConsultas;
...
public class AgendaDeConsultaService {
    ...
    public DatosDetalleConsulta agendar(DatosAgendarConsulta datos){
        ...
        var consulta = new Consulta(medico.get(),paciente,datos.fecha());
